...
int initWorkerCnt = 4;
int const waitTimeForWorkerToConnectInSecond = 300;


int main(){
    int opt = TRUE;
	int master_socket , addrlen , new_socket , client_socket[65] ,
		max_clients = 60 , activity, i , valread , sd;
	int max_sd;
	...
	fd_set readfds;
	//a message
	char *message = "This is master worker\n";
